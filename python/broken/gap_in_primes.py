...
def gap(g, m, n):
    ...
    for iter in sample:
        if iter % 2 != 0:
            primes.append(iter)
            gap_primes = range(primes[0], primes[-1], g)
    return [gap_primes[0], gap_primes[1]]
#
# Test.describe("Gap")
# Test.it("Basic tests")
...
print("inputs are 2, 100, 110 {}").format(gap(2,100,110))  # [101, 103]
print("inputs are 4, 100, 110 {}").format(gap(4,100,110))  # [103, 107]
print("inputs are 6, 100, 110 {}").format(gap(6,100,110))  # None
print('inputs are 8, 300, 400 {}').format(gap(8,300,400))  # [359, 367]
print('inputs are 10, 300, 400 {}').format(gap(10,300,400)) # [337, 347]
